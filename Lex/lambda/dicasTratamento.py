...
def dicasTratamento_intent(event):
    ...
    dicas = [
        ...
        [
            ...
            "Se precisar de mais informações ou orientações, é só me chamar. E lembre-se: ao menor sinal de gravidade, procure um profissional de saúde. Estamos juntos nessa!"
        ]
    ]
